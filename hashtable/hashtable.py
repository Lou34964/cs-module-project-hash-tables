...
class HashTable:
    ...
    def fnv1(self, key):
        ...
        hashIndex = OFFSETBASIS

        bytesToProcess = key.encode()
    ...
    def put(self, key, value):
        ...
        if not self.storage[hashIndex]:
            self.storage[hashIndex] = HashTableEntry(key, value)
            self.itemCount += 1

        else:
            currNode = self.storage[hashIndex]
